...
import { useHasUnreadReleaseNotes, WhatsNewDot, WhatsNewIndicator } from './release-notes/WhatsNewIndicator';
...
export function UserMenu({ userName, onSignOut }: UserMenuProps) {
  ...
  const hasUnreadReleaseNotes = useHasUnreadReleaseNotes();
          ...
          <div className="py-1">
            ...
            >
              ...
              <span className="flex flex-1 items-center justify-between gap-2">
                ...
                <WhatsNewIndicator visible={hasUnreadReleaseNotes} />
              </span>
            </button>
            <button
              onClick={() => {
