                ...
                {tools
                  ...
                  .map((tool) => (
                    <div key={tool.id}>
                      ...
                      ) : tool.name === 'Event Budget Planner' ? (
                        <EventBudgetPlannerTool toolId={tool.id} />
                      ) : tool.name === 'Cleaning Schedule' ? (
                        <CleaningScheduleTool toolId={tool.id} />
                      ) : tool.name === 'Home Maintenance Schedule' ? (
                        <HomeMaintenanceScheduleTool toolId={tool.id} />
                      ) : tool.name === 'End of Life Planner' ? (
                        <EndOfLifePlannerTool toolId={tool.id} />
                      ) : (
                        <div className="rounded-2xl border border-slate-800 bg-slate-900/70 p-6">
